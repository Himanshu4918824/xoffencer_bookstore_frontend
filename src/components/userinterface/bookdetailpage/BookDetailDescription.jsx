...
export default function BookDetailDescription() {

  const data = [{good: "BESTSELLER", type: "HARDCOVER",name: "The Silent Patient",author: "Alex Michaelides",rating: "⭐⭐⭐⭐⭐",des: "Timeless lessons on wealth, greed, and happiness. Doing well with money isn’t necessarily about what you know. It’s about how you behave.", offerprice:'$24.69',price:'$32.65',publicer:'celadon Book',date:'05 Feb 2025',page:'565',issn:'14597823568'}
  ];
    ...
    return data.map((item, i) => (
      <div key={i}>
        ...
        <div className="d-flex align-items-center mb-2">
          <span className="badge bg-primary me-3">{item.good}</span>
          <span className="text-muted fw-semibold">{item.type}</span>
        </div>
       ...
       <div style={{fontSize:35,fontWeight:700}}>
        ...
        <div style={{width:'75%',height:100, borderRadius:10,backgroundColor:'white',margin:5,marginTop:30,display:'flex',alignItems:'center'}}>
            <div style={{padding:20}}>
                ...
                <div style={{fontSize:20,fontWeight:700}}>{item.offerprice} <span style={{margin:2,fontSize:16, color:"#c3b8b8"}}><s>{item.price}</s></span></div>   
            </div>
            
            <div style={{marginLeft:'auto',marginRight:25}}>
                <button type="button" className="btn btn-primary" style={{fontWeight:400,fontSize:20}}>Add To Cart</button>
            </div>  
