...
export default function PaymentDetail()
{
    ...
    return(<div className="container">
       <div className="card shadow-sm p-3 col-12 col-md-10 col-lg-8 mx-auto" style={{border:'0.5px solid #e2e2e2', width:'80%',borderRadius:20}}>
      ...
      <button type="button" className="btn btn-primary" style={{border:'1px solid #ddd',borderRadius:25,width:'80%',letterSpacing:0.5,lineHeight:1.1,fontSize:18,fontWeight:550,margin:10,marginLeft:25}}>Place Order</button>
